...
public class TarefaParte2 {
	public static void main(String[]args)
	{
		...
		System.out.println("Insira os nomes no padrao nome-genero (\"carlos-m\")");
		...
		// Exemplos de nomes para copiar e testar: anna-f,marcelo-m,paula-f,rodrigo-m,fernanda-f,roberto-m,claudia-f,joao-m / beatriz-f,ellen-f,carlos-m,mariana-f,gustavo-m,larissa-f,renato-m,ines-f,fabio-m
